...
| Jul 7 → done Jul 21 | 3 — Final (12) | MOCHA (→Wholesale 2024), Tailwind (→Tailwinds), no-group accounts (→2026), zero-history, Baseling (2026/pending), Kool Beanz (2026/suspended) | ✅ 2026-07-21 (147 orders, 326 lines, 0 warnings) | ✅ 2026-07-21 (10/10 approved sent, BCC Logan; Kool Beanz/Baseling not emailed) | Logan + Claude |
| Jul 21 | **Bunker (1)** | Bunker Uniforms — migrated as a normal Wholesale 2025 account (0 orders) so it can log in; white-label products use per-customer `private` visibility, built separately by staff once base-coffee mapping is chosen (see `docs/bunker-whitelabel-TODO.md`) | ✅ 2026-07-21 | ✅ 2026-07-21 (BCC Logan) | Logan + Claude |
| — | **Excluded** | **Kagen's, Firefly** — early test accounts, the only OS accounts left un-migrated. | — | — | — |
