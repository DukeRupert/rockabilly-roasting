...
func InvoiceShowContent(props InvoiceShowProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "\" class=\"text-sm font-semibold text-hiri-teal hover:text-hiri-teal-dark\">&larr; Back to order</a></div></div><!-- Actions --><div class=\"mt-6 flex flex-wrap gap-3\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if canSendInvoice(props.Invoice) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "\"><button type=\"submit\" class=\"inline-flex items-center gap-1.5 rounded-md bg-hiri-teal px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-hiri-teal-dark\">Send Invoice</button></form>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
