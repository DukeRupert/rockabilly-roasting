	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(props.Plans) == 0 {
			...
			for _, p := range props.Plans {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "\" class=\"w-16 rounded-sm border-0 py-1 px-2 text-sm text-rr-heading border border-rr-border placeholder:text-rr-muted focus:ring-2 focus:ring-inset focus:ring-rr-red\"> <span class=\"text-rr-muted\">%</span> <button type=\"submit\" class=\"rounded px-1.5 py-1 text-xs font-medium text-rr-red hover:text-rr-red-lt\">Save</button></form></td><td class=\"whitespace-nowrap px-3 py-4 text-sm\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
