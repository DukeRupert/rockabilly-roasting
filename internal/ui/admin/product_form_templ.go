...
func ProductForm(props ProductFormProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "\"><div class=\"space-y-8\"><!-- General section --><div class=\"border-b border-rr-border pb-8\"><h2 class=\"text-base/7 font-semibold text-rr-heading\">General</h2><p class=\"mt-1 text-sm/6 text-rr-muted\">Basic product information.</p><div class=\"mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6\"><!-- Title --><div class=\"sm:col-span-4\"><label for=\"title\" class=\"block text-sm/6 font-medium text-rr-heading\">Title</label><div class=\"mt-2\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.ResolveAttributeValue(productVal(props.Product, "title"))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var8, templ_7745c5c3_Err = templ.ResolveAttributeValue(productVal(props.Product, "slug"))
		if templ_7745c5c3_Err != nil {
		...
		for _, t := range props.Taxons {
			if props.Product != nil && props.Product.TaxonID == t.ID {
				...
				templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.ResolveAttributeValue(t.ID.String())
				if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var19, templ_7745c5c3_Err = templ.ResolveAttributeValue(productDateVal(props.Product, "available_on"))
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Var22, templ_7745c5c3_Err = templ.ResolveAttributeValue(productDateVal(props.Product, "discontinue_on"))
		if templ_7745c5c3_Err != nil {
