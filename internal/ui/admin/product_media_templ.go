	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(props.Media) > 0 {
			...
			for i, m := range props.Media {
				...
				templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.ResolveAttributeValue(mediaURL(m, props.MediaConfig))
				if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.ResolveAttributeValue(m.AltText)
				if templ_7745c5c3_Err != nil {
				...
				if i != 0 {
					...
					templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("/admin/catalog/%s/images/%s/primary", props.ProductID, m.ID))
					if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.ResolveAttributeValue(fmt.Sprintf("/admin/catalog/%s/images/%s/delete", props.ProductID, m.ID))
				if templ_7745c5c3_Err != nil {
