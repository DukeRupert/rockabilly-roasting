...
func Storefront(props StorefrontProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<link rel=\"icon\" type=\"image/svg+xml\" href=\"/static/rockabilly-logo.svg\"><link rel=\"preconnect\" href=\"https://fonts.googleapis.com\"><link rel=\"preconnect\" href=\"https://fonts.gstatic.com\" crossorigin><link href=\"https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Boogaloo&family=Playfair+Display:ital,wght@0,700;1,400;1,700&family=Barlow:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap\" rel=\"stylesheet\"><link rel=\"stylesheet\" href=\"/static/css/output.css\"><script src=\"/static/js/htmx.min.js\"></script><script defer src=\"https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js\"></script><style>[x-cloak] { display: none !important; }</style></head><body class=\"h-full font-body text-rr-body bg-rr-bg\" hx-boost=\"true\" hx-target=\"#main-content\" hx-swap=\"innerHTML\"><!-- Promo ticker (disabled — uncomment class to re-enable) --><div class=\"hidden overflow-hidden bg-rr-amber-dark\"><div class=\"marquee-inner py-1.5\"><span class=\"label-font text-white px-8 text-xs\">FREE SHIPPING ON ORDERS OVER $40</span> <span class=\"px-5 text-white/40\">&loz;</span> <span class=\"label-font text-white px-8 text-xs\">SUBSCRIBE &amp; SAVE 10%</span> <span class=\"px-5 text-white/40\">&loz;</span> <span class=\"label-font text-white px-8 text-xs\">ROASTED FRESH TO ORDER</span> <span class=\"px-5 text-white/40\">&loz;</span> <span class=\"label-font text-white px-8 text-xs\">FREE SHIPPING ON ORDERS OVER $40</span> <span class=\"px-5 text-white/40\">&loz;</span> <span class=\"label-font text-white px-8 text-xs\">SUBSCRIBE &amp; SAVE 10%</span> <span class=\"px-5 text-white/40\">&loz;</span> <span class=\"label-font text-white px-8 text-xs\">ROASTED FRESH TO ORDER</span> <span class=\"px-5 text-white/40\">&loz;</span></div></div><!-- Header --><header class=\"bg-rr-raised border-b border-rr-border\"><nav class=\"mx-auto max-w-7xl px-4 sm:px-6 lg:px-8\"><div class=\"flex h-16 items-center justify-between\"><!-- Logo --><div class=\"flex items-center\"><a href=\"/\" class=\"flex items-center gap-3\"><img src=\"/static/rockabilly-logo.svg\" alt=\"Rockabilly Roasting Co.\" class=\"h-10 w-auto flex-shrink-0\"><div><p class=\"font-display text-rr-heading text-lg leading-none tracking-widest\">ROCKABILLY</p><p class=\"label-font text-rr-amber text-[0.55rem]\" style=\"letter-spacing:0.3em;\">ROASTING CO.</p></div></a></div><!-- Desktop nav --><div class=\"hidden sm:flex sm:items-center sm:gap-x-7\"><a href=\"/catalog\" class=\"nav-link font-body text-sm font-semibold text-rr-heading\">Shop</a> <a href=\"/wholesale\" class=\"nav-link font-body text-sm font-semibold text-rr-muted hover:text-rr-heading transition-colors\">Wholesale</a> <a href=\"/about\" class=\"nav-link font-body text-sm font-semibold text-rr-muted hover:text-rr-heading transition-colors\">About</a></div><!-- Cart + Subscribe + mobile menu --><div class=\"flex items-center gap-x-3\"><!-- Cart icon --><div class=\"relative\"><a href=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/layouts/storefront.templ`, Line: 80, Col: 48}
		}
		...
		if props.CartCount > 0 {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/ui/layouts/storefront.templ`, Line: 88, Col: 46}
			}
